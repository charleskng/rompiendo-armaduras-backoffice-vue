                ...
                <el-row>
                    <el-col :span="24">
                        <el-breadcrumb separator="/">
                            ...
                            <el-breadcrumb-item>NOTICIAS</el-breadcrumb-item>
                        </el-breadcrumb>
                    </el-col>
                </el-row>
            </el-header>
    ...
    export default {
        setup() {
            ...
            const deleteItem = (id, title) => {
                ElMessageBox.confirm(`¿Quieres eliminar la noticias "${title}" con id ${id}?`)
                .then(() => {
                    requestDelete(id)
                })
                .catch(() => {
            ...
            const requestDelete = async(id) => {
                ...
                let response = await request.send({
                    method: 'DELETE',
                    url: `${import.meta.env.VITE_API_SYSTEM_URL}/news/${id}`,
                    headers: {
                        'content-type': 'application/json',
                        'session': appStore.session
                    }
