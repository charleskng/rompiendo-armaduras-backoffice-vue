    ...
    export default {
        setup() {
            ...
            const requestPlan = async() => {
                ...
                let response = await request.send({
                    method: 'GET',
                    url: `${import.meta.env.VITE_API_SYSTEM_URL}/nutritional_plan/${route.params.id}`,
                    headers: {
                        'content-type': 'application/json',
                        'session': appStore.session
                    }
                ...
                form.name = response.data.plan.name
                form.desc = response.data.plan.desc
            ...
            const requestEdit = async() => {
                ...
                const loading = ElLoading.service({
                    lock: true,
                    text: 'Actualizando Plan Nutricional',
                    background: 'rgba(23, 23, 23, 0.6)'
                })
                ...
                if(error === null) {
                    ...
                    // redirect to view
                    ElMessage.success('Plan nutricional actualizado exitosamente')
